...
export default function DrawPage({ navigate }) {
  ...
  async function createBackground(e) {
    e.preventDefault();
    ...
    setSaving(true);
    try {
      const res = await fetch(`/api/my-progimon/${encodeURIComponent(progimonId)}/background`, {
        method: "PUT",
  ...
  return (
    <PageShell title="Make your Progi's digs!" useBg={false}>
      ...
      <div style={{ textAlign: "center", marginTop: 10 }}>
        <button id="createbutton" type="button" onClick={createBackground} disabled={saving}>
